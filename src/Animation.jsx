        ...
        <div className="page-padding-5">
            <div className="container-large">
                <div className="w-layout-grid layout349_component">
                    <div id="w-node-_45b1d4c4-e943-021b-827b-af2ee8e915af-10cfef58" className="layout349_content-wrapper">
                        <div className="layout349_content">
                            <div className="margin-bottom margin-xsmall">
                                <div className="text-weight-semibold"><span className="text-span-11">Kula Outreach</span></div>
                            </div>
                            <div className="margin-bottom margin-small">
                                <h2 className="heading-10">Automated Candidate Follow-ups</h2>
                            </div>
                            <p className="text-size-medium-2">For prospective candidates, send automated, periodic follow-ups
                                and value-adds to nurture long-term relationships<br/></p>
                            <div className="layout349_mobile-image-wrapper"><img
                                    src="https://global-uploads.webflow.com/62efc7cb58ad153bfb146988/630cbfe1db67cfefc1a55580_ot.png"
                                    loading="lazy"
                                    ...
                                    sizes="(max-width: 479px) 100vw, (max-width: 767px) 90vw, 100vw" alt=""
                                    className="layout349_mobile-image"/></div>
                            <div className="background-holder">
                                <div className="background-layer-2 background-color-1"></div>
                            </div>
                        </div>
                        <div data-w-id="45b1d4c4-e943-021b-827b-af2ee8e915c5" className="layout349_content">
                            <div className="margin-bottom margin-xsmall">
                                <div className="text-weight-semibold"><span className="text-span-11">Kula Outreach</span></div>
                            </div>
                            <div className="margin-bottom margin-small">
                            ...
                            <p className="text-size-medium-2">No more spray and pray. Ensure 1:1 communication to all of your
                                connections through dynamic personalization capabilities</p>
                            <div className="layout349_mobile-image-wrapper"><img
                                    src="https://global-uploads.webflow.com/62efc7cb58ad153bfb146988/630db209a7ad3f0c0cc274a5_follow-yp-design.png"
                                    loading="lazy"
                        ...
                        <div data-w-id="45b1d4c4-e943-021b-827b-af2ee8e915da" className="layout349_content">
                            <div className="margin-bottom margin-xsmall">
                                <div className="text-weight-semibold"><span className="text-span-11">Kula Outreach</span></div>
                            </div>
                            <div className="margin-bottom margin-small">
                                <h2 className="heading-10"><strong>Reach out on channels candidates prefer</strong></h2>
                            </div>
                            <p className="text-size-medium-2">Devise multichannel engagement flows with email, LinkedIn
                                requests, and InMails.</p>
                            <div className="layout349_mobile-image-wrapper"><img
                                    src="https://global-uploads.webflow.com/62efc7cb58ad153bfb146988/630b0fb6083655ed2c004ebb_out-2.png"
                                    loading="lazy"
